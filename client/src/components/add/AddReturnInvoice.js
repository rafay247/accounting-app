...
const AddReturnInvoice = () => {
  ...
  const handleChange = (e, index) => {
    ...
    setItemData(list)
    setGrandTotal(calculateGrandTotal(item_data))
  }
  ...
  const handleSubmit = async (event) => {
    ...
    payload = { date, ref_no, type, company_name, item_data }
    await ReturnInvoiceApi.createReturnInvoice(payload)
  ...
  const calculateGrandTotal = (items) => {
    console.log(items)
    return items.reduce((previous, current) => previous += current.total_amount, 0)
  }
      ...
      <form onSubmit={(e) => handleSubmit(e)}>
        <div className="card">
          <div className="bg-dark card-header text-center">
            <h2 style={{ color: "navajowhite" }}>Retrun Invoice</h2>
          </div>
          <div className="card-body">
            ...
            <div className="row mb-4">
              <div className="col-3">
                <label htmlFor="grand-total" className="form-label">
                  Grand Total
                </label>
              </div>
              <div className="col-3 offset-6">
